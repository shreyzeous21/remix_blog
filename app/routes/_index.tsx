    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="items-center spacey-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          <img
            src={"https://avatars.githubusercontent.com/u/79036238?v=4"}
            alt="Image of myself"
          ...
          <p className="text-gray-500 dark:text-gray-400 text-center">
            Hey my name is Shrey and I am a Full Stack Developer
          </p>
          ...
          <div className="flex space-x-5 pt-6">
            ...
            <a href="https://instagram.com/shrey_sadhukha" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
              >
                <path d="M768 48H256c-115.6 0-208 92.4-208 208v560c0 115.6 92.4 208 208 208h512c115.6 0 208-92.4 208-208V256c0-115.6-92.4-208-208-208zM512 832c-118.7 0-216-97.3-216-216s97.3-216 216-216 216 97.3 216 216-97.3 216-216 216zM752 416c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zM512 704c-106.1 0-192-85.9-192-192s85.9-192 192-192 192 85.9 192 192-85.9 192-192 192zM512 416c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z" />
              </svg>
            </a>
          </div>
        </div>
        <div className="prose max-w-none prose-lg pt-8 pb-8 dark:prose-invert xl:col-span-2">
          ...
          <p>
            Building applications with React and NextJS and sharing them on
